...
const records = await sbFetchSch(`schedule?select=*&agent_id=eq.${schMyAgentId}&shift_date=gte.${thisWeekStartIso}&shift_date=lte.${nextWeekEndIso}&week_id=in.(${publishedWeekIds})`);
const schedMap = {};
